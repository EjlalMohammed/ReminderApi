...
{
    public class BaseRepository<T>(Data.ReminderDbContext productDbContext) : IBaseRepository<T> where T : class
    {
        private readonly Data.ReminderDbContext _context = productDbContext;
