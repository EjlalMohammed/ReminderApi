...
{
    public class AppointmentController(IAppointmentService service, ILogger<BaseController> _logger) : BaseController(_logger)
    {
        private readonly IAppointmentService _service = service;
        [HttpGet]

        public async Task<ActionResult<Results<IEnumerable<AppointmentDTO>>>> Get()
        {
            try
            {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Results<AppointmentDTO>>> Get(Guid id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Post(AppointmentDTO entity)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<IActionResult> Put(AppointmentDTO entity)
        {
            try
            {
